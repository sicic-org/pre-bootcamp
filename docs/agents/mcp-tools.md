...
* **`web_search_tool`**: The "Eyes". Allows Lunar to scan the live web instead of relying on outdated training data.
* **Filesystem Tool**: The "Hands". Allows your agent to read your `USER.md` for context and write intelligence reports into your `Lunar_Archive`.
